...
// =====================================================================
	...
	public boolean execute() {
		try {
			...
			switch (format) {
				case "neighborlist" -> GraphIO.writeNeighborList(g, pstr);
				case "edgelist" -> GraphIO.writeEdgeList(g, pstr);
				case "chaco" -> GraphIO.writeChaco(g, pstr);
				case "netmeter" -> GraphIO.writeNetmeter(g, pstr);
				case "gml" -> GraphIO.writeGML(g, pstr);
				case "dot" -> GraphIO.writeDOT(g, pstr);
				default -> System.err.println(name + ": unsupported format " + format);
			}
