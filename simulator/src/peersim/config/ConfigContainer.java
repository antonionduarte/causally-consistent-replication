...
//===================================================================
	 ...
	 */
	private final Map<String, Integer> protocols;
...
//						+ "\nPossibly incorrect property: " + getSimilarProperty(property));
		...
		for (String symbol : symbols) {
			Object d = getVal(initial, symbol, depth + 1);
			jep.addVariable(symbol, d);
		}
...
// -------------------------------------------------------------------
	 ...
	 *
	 * @param jep the java expression parser containing the list of variables
...
// -------------------------------------------------------------------
	 ...
	 *
	 * @param name The component type (i.e. prefix of the list of configuration
...
// -------------------------------------------------------------------
	 ...
	 *
	 * @param names the set of property names to be searched
	 * @param type  the string identifying the particular set of properties to be
	 *              inspected
	 */
